...
class ImageController extends AbstractController
{
    ...
    public function new(Request $request,$id , ImageRepository $imageRepository): Response
    {
        ...
        $images=$imageRepository->findBy(['note'=>$id]);
    ...
    /**
     * @Route("/{id}/{Nid}", name="admin_image_delete", methods={"DELETE"})
     */
    public function delete(Request $request,$Nid, Image $image): Response
    {
        ...
        return $this->redirectToRoute('admin_image_new', ['id'=>$Nid]);
    }
